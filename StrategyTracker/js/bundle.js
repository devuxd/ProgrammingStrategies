            ...
            $scope.chooseNextStatement = function ($event) {
                ...
                if ($scope.activeLines.length > 1) {
                    ...
                    for (var x = 0; x < $scope.activeLines.length; x++) {
                        ...
                        if (currentTarget.includes(line)) chosenStatement = line;
                    }
